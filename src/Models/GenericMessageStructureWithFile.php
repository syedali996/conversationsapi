...
/**
 *Generic Message Structure With File
 */
class GenericMessageStructureWithFile implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\FileMessageStructure $content public property
     */
    public $content;
     ...
     * @param FileMessageStructure      $content   Initialization value for $this->content
