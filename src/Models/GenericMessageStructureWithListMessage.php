...
/**
 *Generic Message Structure With ListMessage
 */
class GenericMessageStructureWithListMessage implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\ListMessageStructure $content public property
     */
    public $content;
     ...
     * @param ListMessageStructure      $content   Initialization value for $this->content
