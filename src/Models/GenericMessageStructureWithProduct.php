...
/**
 *Generic Message Structure With Product
 */
class GenericMessageStructureWithProduct implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\ProductMessageStructure $content public property
     */
    public $content;
     ...
     * @param ProductMessageStructure   $content   Initialization value for $this->content
