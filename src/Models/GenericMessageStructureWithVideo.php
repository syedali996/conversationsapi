...
/**
 *Generic Message Structure With Video
 */
class GenericMessageStructureWithVideo implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\VideoMessageStructure $content public property
     */
    public $content;
     ...
     * @param VideoMessageStructure     $content   Initialization value for $this->content
