...
/**
 *Generic Message Structure With Contacts
 */
class GenericMessageStructureWithContacts implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\ContactsMessageStructure $content public property
     */
    public $content;
     ...
     * @param ContactsMessageStructure  $content   Initialization value for $this->content
