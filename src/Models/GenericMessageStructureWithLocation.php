...
/**
 *Generic Message Structure With Location
 */
class GenericMessageStructureWithLocation implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\LocationMessageStructure $content public property
     */
    public $content;
     ...
     * @param LocationMessageStructure  $content   Initialization value for $this->content
