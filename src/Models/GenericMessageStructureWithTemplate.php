...
/**
 *Generic Message Structure With Template
 */
class GenericMessageStructureWithTemplate implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\TemplateMessageStructure $content public property
     */
    public $content;
     ...
     * @param TemplateMessageStructure  $content   Initialization value for $this->content
