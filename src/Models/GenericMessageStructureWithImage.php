...
/**
 *Generic Message Structure With Image
 */
class GenericMessageStructureWithImage implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\ImageMessageStructure $content public property
     */
    public $content;
     ...
     * @param ImageMessageStructure     $content   Initialization value for $this->content
