...
/**
 *Generic Message Structure With Audio
 */
class GenericMessageStructureWithAudio implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\AudioMessageStructure $content public property
     */
    public $content;
     ...
     * @param AudioMessageStructure     $content   Initialization value for $this->content
