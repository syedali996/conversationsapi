...
/**
 *Generic Message Structure With ReplyButton
 */
class GenericMessageStructureWithReplyButton implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\ReplyButtonMessageStructure $content public property
     */
    public $content;
     ...
     * @param ReplyButtonMessageStructure $content   Initialization value for $this->content
