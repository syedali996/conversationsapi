...
/**
 *Generic Message Structure With Product List
 */
class GenericMessageStructureWithProductList implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \ConversationsAPILib\Models\ProductListMessageStructure $content public property
     */
    public $content;
     ...
     * @param ProductListMessageStructure $content   Initialization value for $this->content
