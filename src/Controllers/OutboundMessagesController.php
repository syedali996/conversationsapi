 ...
 */
class OutboundMessagesController extends BaseController
{
    /**
     * @var OutboundMessagesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return OutboundMessagesController The *Singleton* instance.
     */
     ...
     *
     * @param Models\GenericMessageStructure $body         Request with correct body for the message type you want to
     *                                                     send.
